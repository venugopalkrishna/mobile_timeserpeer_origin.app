...
const ReceiptEntry = ({ vNo, selectedParty, selectedDate, refreshVno, billNoAPI, resetparty }) => {
    ...
    const handleSave = async (vn, bill) => {
        ...
        if (metal <= 0 && cash <= 0) {
            message.warning("Enter Metal or Cash");
            return;
        }
        ...
        try {
            ...
            payload.push({
                ...
                gjama: Number(weight) || 0,
                gnama: 0,
                touch: Number(touch) || 0,
                pjama: Number(paidMetal) || 0,
                pnama: 0,
                cjama: Number(paidCash) || 0,
                cnama: 0,
                vno: bill,
                vtype: "CUSTOMER",
                stype: "RECEPIT",
